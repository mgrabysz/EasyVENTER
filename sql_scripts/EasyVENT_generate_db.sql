...
CREATE TABLE z01.client_data (
    client_id  NUMBER(*, 0)
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 CACHE 20 ) NOT NULL,
    name       VARCHAR2(20 BYTE) NOT NULL,
...
ALTER TABLE z01.seats ADD CONSTRAINT seats_pk PRIMARY KEY ( seat );
...
ALTER TABLE z01.seats
    ADD CONSTRAINT seats_ticket_quantities_fk FOREIGN KEY ( ticket_quantity_id )
