...
BEGIN
    ...
    INSERT INTO z01.organizer_data(name, surname, email, telephone, date_registered, company_id) VALUES (name, surname, email, telephone, date_reg, company);

    SELECT organizer_id INTO user_id FROM z01.organizer_data WHERE z01.organizer_data.surname = surname ORDER BY organizer_id DESC NULLS LAST FETCH FIRST 1 ROWS ONLY;
